# Generated by Django 2.0.5 on 2018-11-10 13:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('00', '00'), ('1B', '1B'), ('1A', '1A'), ('2B', '2B'), ('2A', '2A'), ('3B', '3B'), ('3A', '3A'), ('4B', '4B'), ('4A', '4A'), ('5B', '5B'), ('5A', '5A'), ('6B', '6B'), ('6A', '6A'), ('7B', '7B'), ('7A', '7A'), ('8B', '8B'), ('8A', '8A'), ('9B', '9B'), ('9A', '9A'), ('10B', '10B'), ('10A', '10A'), ('11B', '11B'), ('11A', '11A'), ('12B', '12B'), ('12A', '12A')], default='00', max_length=4, verbose_name='岗位级别')),
                ('entryDate', models.DateField(default=datetime.date.today, verbose_name='入职日期')),
                ('depart', models.CharField(default='0', max_length=10, null=True, verbose_name='部门')),
                ('productUnit', models.CharField(default='0', max_length=10, null=True, verbose_name='产品线')),
                ('projectName', models.CharField(default='0', max_length=20, null=True, verbose_name='项目组名')),
